const lang = {
  "es": {
    ...
    "returnBook-success": "El libro se ha devuelto correctamente",
    "returnBook-select": "Selecciona un libro para devolver",
    "save": "Guardar",
    "imageSelect": "Selecciona una imagen",
    "deleteUser": "Se eliminará al siguiente usuario",
    "confirmation": "¿Estás seguro?",
    "changeAviability": "Cambiar disponibilidad",
    "deleteBook": "Eliminar este libro",
    "deleteAllBooks": "Eliminar todos los libros de este tipo",
    "noActiveRents": "No tienes ningún préstamo activo",
    ...
    "deleteCommentDialog-title": "Se eliminará el siguiente comentario",
    "content": "Contenido",
    "type": "Tipo",
    "send-confirmation": "Se ha enviado correctamente",
    "catalog-hint": "Escribe un título para buscarlo",
    "add": "Añadir",
    "contactTypes": "Tipos de soporte",
    "deleteContactTypeDialog-title":
        "Se eliminará el siguiente tipo de soporte",
    "deleteEditorial-title": "Se eliminará la siguiente editorial",
    "deleteLanguage-title": "Se eliminará el siguiente idioma",
    "deleteCategory-title": "Se eliminará la siguiente categoría",
